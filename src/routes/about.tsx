...
const aboutTitle = "About Justin Malonson | Software Engineer";
const aboutDescription =
  "Learn about Justin Malonson, a software engineer whose work spans distributed systems, cryptography, cybersecurity, blockchain architecture, artificial intelligence, and sovereign computing.";
    ...
    scripts: [
      jsonLd([
        website(),
        {
          ...
          "@id": PROFILE_PAGE_ID,
          url: ABOUT_URL,
          name: "Justin Malonson | Software Engineer",
          description: aboutDescription,
        ...
        imageObject(),
        organization(),
        breadcrumb(`${ABOUT_URL}#breadcrumb`, [
          { name: "Home", url: HOME_URL },
          { name: "About Justin Malonson", url: ABOUT_URL },
        ]),
      ]),
    ],
  }),
      ...
      <main>
        ...
        <section className="px-5 pt-10 md:px-8 md:pt-16">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-[minmax(0,1fr)_minmax(280px,480px)] md:gap-x-12 md:gap-y-0">
            <header className="md:col-start-1 md:row-start-1">
              ...
              <h2 className="mt-7 text-2xl font-medium tracking-tight sm:text-3xl md:text-4xl">
                Software Engineer
              </h2>
            </header>
        ...
        <section className="px-5 py-[clamp(4rem,6vw,6rem)] md:px-8">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            <p className="text-lg leading-relaxed md:col-span-2">
              Justin Malonson is a software engineer whose work centers on the foundations of
              digital sovereignty. His engineering practice spans distributed systems, cryptography,
              cybersecurity, blockchain architecture, and artificial intelligence infrastructure. As
              Founder and CEO of Blockchain Computer Inc., he leads research and engineering
              programs that let people, institutions, and machines transact, compute, and prove
              things to one another without surrendering control to centralized intermediaries. His
              broader work also encompasses computer science, entrepreneurship, and authorship.
            </p>
            <div className="space-y-6 text-sm">
              <div className="border-t border-foreground pt-5">
                <p className="label text-muted-foreground">Primary occupation</p>
                <p className="mt-2">Software Engineer</p>
              </div>
              <div className="border-t border-foreground pt-5">
                <p className="label text-muted-foreground">Organization</p>
        ...
        <section className="border-t border-foreground bg-foreground px-5 py-[clamp(4rem,6vw,6rem)] text-background md:px-8">
          <div className="mb-12 flex items-end justify-between border-b border-background/30 pb-6">
            ...
            <span className="text-xs text-background/60">02 / Company</span>
          </div>
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
            <div className="space-y-6 text-base leading-relaxed text-background/85">
              <p>
                Justin's path into computer science began with an early fascination for how
                networks, code, and cryptography quietly shape the modern world. Long before
                founding Blockchain Computer Inc., he was building software, studying the
                architecture of the internet, and exploring how cryptographic systems could shift
                power back toward individuals.
              </p>
              <p>
            ...
            <div className="space-y-6 text-base leading-relaxed text-background/85">
              <p>
                He founded Blockchain Computer Inc. to pursue that thesis at the infrastructure
                level. The company brings together cryptography, distributed systems, and AI
                research to design the protocols and primitives needed for a more open, verifiable,
          ...
          <div className="grid grid-cols-1 gap-px bg-foreground md:grid-cols-2">
            <article className="flex flex-col bg-background p-8 md:p-10">
              ...
              <p className="mb-6 text-sm text-muted-foreground">
                Leading the company's research and engineering roadmap across decentralized
                identity, verifiable computation, and cryptographic infrastructure for sovereign
                digital systems.
              </p>
            ...
            <article className="flex flex-col bg-background p-8 md:p-10">
              ...
              <p className="mb-6 text-sm text-muted-foreground">
                Ongoing work on Web5-aligned infrastructure, agentic-AI accountability, and
                frameworks for embedding cryptographic verifiability into autonomous systems.
              </p>
              <ul className="space-y-3 border-t border-foreground pt-5 text-sm">
                <li className="flex justify-between border-b border-foreground/20 pb-3">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2">
              <p className="text-base leading-relaxed text-background/85">
                ...
                computation they can trust — without depending on opaque intermediaries.
                Cryptography, decentralized systems, and verifiable computation are the tools to
                make that possible.
              </p>
              <p className="text-base leading-relaxed text-background/85">
                ...
                distributes power across networks rather than platforms, and keeps human agency at
                the center as AI systems become more autonomous.
              </p>
            </div>
          </div>
        </section>
